...
class HubSpotService(NangoService):
    ...
    async def get_all_contacts(self, connection_id: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            result = await self.fetch_data(connection_id, "contacts", params, 'hubspot')
    ...
    async def update_leads(self, connection_id: str, payload: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        return await self.post_data(connection_id, "leads", payload, 'hubspot', True)
